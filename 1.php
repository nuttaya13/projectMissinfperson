...
<?php $sql = "SELECT tblreport.Fullname,tblbrands.BrandName,tblreport.Nickname,tblreport.Sex,tblreport.Age,tblreport.id,tblreport.Typepreson,tblreport.Overview,tblreport.CallPhone,tblreport.Vimage1,tblreport.Status 
...
<div class="col-list-3">
      <div class="recent-car-list">
              <div align="center" class="car-info-box"> 
                   <a target ="_blank" href="details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/uplode/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image" height="80%" width="80%"></a>
                   <ul>
      ...
      <h6>เบอร์โทรติดต่อกลับ</h6> <ul><font color="#FF0000"> <?php echo substr($result->CallPhone,0,70);?> </font></ul>
      </div>
      </div>
      </div> 
<?php }}?>
