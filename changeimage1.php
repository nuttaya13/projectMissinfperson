...
$sql="update tblreport set Vimage1=:vimage1 where id=:id";
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage1 from tblreport where tblreport.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="admin/img/uplode/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
