			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">รายชื่อผู้สูญหาย</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">รายชื่อผู้สูญหาย</div>
...
<?php $sql = "SELECT tblreport.Fullname,tblbrands.BrandName,tblreport.Nickname,tblreport.Sex,tblreport.Age,tblreport.id,tblreport.DateMissing,tblreport.TimeMissing,tblreport.Typepreson,tblreport.Overview,tblreport.CallPhone,tblreport.Vimage1,tblreport.userEmail,tblreport.Status,tblreport.Place
 from tblreport join tblbrands on tblbrands.id=tblreport.Brand";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
		...
		<td><a href="edit-report.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="list-report.php?del=<?php echo $result->id;?>" onclick="return confirm('คุณต้องการจะลบรายชื่อ');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
