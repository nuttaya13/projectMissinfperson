...
Place='$place',Tambol='$tambol',District='$district',Province='$province',Overview='$overview',Callphone='$callphone'
where id=$id ";
...
<div class="form-group">
<div class="col-sm-5">
Image 1<img src="img/uplode/<?php echo htmlentities($result->Vimage1);?>" width="300"  style="border:solid 1px #000">
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Change Image</a>
</div>
<div class="col-sm-5">
Image 2<img src="img/uplode/<?php echo htmlentities($result->Vimage2);?>" width="300"  style="border:solid 1px #000">
