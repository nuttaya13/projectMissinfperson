...
$sql="update tblreport set Vimage2=:vimage2 where id=:id";
$query = $dbh->prepare($sql);
$query->bindParam(':vimage2',$vimage1,PDO::PARAM_STR);
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage2 from tblreport where tblreport.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="admin/img/uplode/<?php echo htmlentities($result->Vimage2);?>" width="400" height="350" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
