...
<div class="page-header_wrap">
      <div class="page-heading">
        <h1>คำค้นหา  "<?php echo $_POST['searchdata1'];?>"</h1>
      </div>
    </div>
  </div>
...
$searchdata1=$_POST['searchdata1'];
$sql = "SELECT * from tblreport 
where  tblreport.Sex LIKE '%$searchdata1%' ";;

$query = $dbh -> prepare($sql);
$query -> bindParam(':search',$searchdata1, PDO::PARAM_STR);
$query->execute();
